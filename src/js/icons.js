// Creeky v13 - Iconos SVG monocromo (formales, blanco y negro)
// Los emojis solo viven en las listas (los elige el usuario). Todo lo demás: SVG.
const PATHS = {
...
export const ic = (name, size = 18) => `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${PATHS[name] || ''}</svg>`;
